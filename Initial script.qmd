...
merged_data_clean <- merged_data %>% 
  select(
    ...
    `Publisher Names`,
    `host_organization`, #The host website that the DOI for the paper takes you to
    ...
    `has_fulltext`,
    `is_oa`,`primary_topic_display_name`,`News mentions`,`Policy mentions`, `X mentions`,`Facebook mentions`,`Number of Mendeley readers`,`Altmetric Attention Score`,`cited_by_count`,`is_retracted`)
